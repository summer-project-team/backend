...
exports.up = function(knex) {
  return Promise.all([
    ...
    knex.schema.hasTable('error_logs').then(function(exists) {
      if (!exists) {
    ...
    knex.schema.hasTable('system_metrics').then(function(exists) {
      if (!exists) {
        return knex.schema.createTable('system_metrics', function(table) {
          table.increments('id').primary();
    ...
    knex.schema.hasTable('api_performance').then(function(exists) {
      if (!exists) {
        return knex.schema.createTable('api_performance', function(table) {
          table.increments('id').primary();
